function Cart({ image }) {
  const x = false;
  return (
    <div className=" border-2 border-[#F6F9FC] relative p-3 h-[410px] cursor-pointer ">
      ...
      <div className="absolute  bottom-0 left-0 right-0 p-3">
        <p className="font-semibold text-2xl">Comforable Sofa</p>
        ...
        <div className="flex justify-between mt-2 items-center">
          <p className="text-green-600 text-sm font-semibold">
            $120.00 <span className="line-through text-[#7D879C]">$150.00</span>
          </p>
